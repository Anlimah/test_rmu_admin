...
<body>
    ...
    <main id="main" class="main-content">
                ...
                <div class="card recent-sales overflow-auto">
                    ...
                    <div class="card-body">
                        <table class="table table-borderless datatable table-striped table-hover">
                            ...
                            <tbody>
                                <?php
                                $course_list = $course->fetch();
                                if (!empty($course_list) && is_array($course_list)) {
                                    $index = 1;
                                    foreach ($course_list as $aa) {
                                ?>
                                        <tr>
                                            <td><?= $index ?></td>
                                            <td><?= $aa["code"] ?></td>
                ...
                <div class="modal-content">
                    ...
                    <form id="editCourseForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary editCourse-btn">Save</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-- Add New Staff Modal -->
        <div class="modal" id="uploadCourseModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    <button class="close-btn" onclick="closeModal('uploadCourseModal')">×</button>
                    ...
                    <form id="uploadCourseForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="file" name="uploadCourseFile" id="uploadCourseFile" required>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" onclick="closeModal('uploadCourseModal')">Cancel</button>
                            <button type="submit" class="btn btn-primary uploadCourse-btn">Upload</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#uploadCourseFile").change(function() {
            ...
            $("#uploadCourseForm").on("submit", function(e) {
                ...
                $.ajax({
                    ...
                    ajaxStart: function() {
                        $(".uploadCourse-btn").prop("disabled", true).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Uploading...');
                    },
                    ajaxStop: function() {
                        $(".uploadCourse-btn").prop("disabled", false).html('Upload');
                    }
                });
            });
            ...
            $("#addCourseForm").on("submit", function(e) {
                ...
                $.ajax({
                    ...
                    ajaxStart: function() {
                        $(".addCourse-btn").prop("disabled", true).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Uploading...');
                    },
                    ajaxStop: function() {
                        $(".addCourse-btn").prop("disabled", false).html('Upload');
                    }
                });
            });
            ...
            $("#editCourseForm").on("submit", function(e) {
                ...
                $.ajax({
                    ...
                    ajaxStart: function() {
                        $(".editCourse-btn").prop("disabled", true).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Uploading...');
                    },
                    ajaxStop: function() {
                        $(".editCourse-btn").prop("disabled", false).html('Upload');
                    }
                });
            });
